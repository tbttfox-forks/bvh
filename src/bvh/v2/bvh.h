...
struct Bvh {
    ...
    void closest_point(Vec<Scalar, Node::dimension>& p, Node top, Stack&, LeafFn&&, Scalar max_dist) const;
...
template <typename Node>
template <typename Stack, typename LeafFn>
void Bvh<Node>::closest_point(Vec<Scalar, Node::dimension>& p, Node start, Stack& node_stack, LeafFn&& leaf_fn, Scalar max_dist) const{
